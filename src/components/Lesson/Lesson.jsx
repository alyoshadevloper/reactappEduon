...
export default function Lesson(props) {
  ...
  const finalUpload = async () => {
    ...
    try {
      ...
      await axios
        .post(`${process.env.REACT_APP_STREAM_API}/media/upload`, formData, { headers })
        .then((res) => {
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="rowGrid">
            ...
            <div className="col-12">
              ...
              >
                <label style={{ textTransform: "capitalize" }} htmlFor="video">
                  {!videoIsEdited && (
                  ...
                  {videoFile
                    ...
                    : !videoIsEdited
                    ? "Videoni o'chirish & yangi vide yuklash"
                    : "yangi video yuklash"}{" "}
                </label>
                {videoIsEdited && (
                  <input
