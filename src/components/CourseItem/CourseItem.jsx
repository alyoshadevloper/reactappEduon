...
export default function CourseItem(props) {
  ...
  // const [artificialAddedToFav, setArtificialAddedToFav] = useState(false);
  ...
  useEffect(() => {
    try {
      axios
        ...
        .then((res) => {
          setisBought(res.data.some((item) => item.course.id === props.id));
        })
        .catch((err) => {
      ...
      <div className={props.class}>
        ...
        >
          <div className="item-header">
            ...
            />
            {props.label ? (
              <div className={props.label.labelColor + " label"}>
          ...
          >
            {props.trainer == null ? " " : props.trainer}
          </p>
        ...
        >
          <div className={popupSelfShow || popupShow ? "popup" : "scale0"}>
            ...
            <div className="btn_popup">
              {props.dicountAvailable ? (
                <button>Chegirmadagi kurs</button>
              ) : null}
              <p>
                Yangilangan:{" "}
