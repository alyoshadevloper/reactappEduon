...
function Watching() {
  ...
  useEffect(() => {
    try {
      axios
        ...
        .then((res) => {
          setDatas(res.data);
          // setVideoUrl(res.data[0].lessons[0].video_lesson_url);
          // res.data.map(items=>{
          console.log(res.data);
          const url = {
            resolution_240p: res.data.length > 0 && res.data[0].resolution_240p,
            resolution_360p: res.data.length > 0 && res.data[0].resolution_360p,
            resolution_480p: res.data.length > 0 && res.data[0].resolution_480p,
            resolution_720p: res.data.length > 0 && res.data[0].resolution_720p,
            resolution_1080p:
              res.data.length > 0 && res.data[0].resolution_1080p,
          };
  ...
  const nextFunc = () => {
    ...
    console.log(datas[activeModuleIndex]);
  };
  const prevFunc = () => {
    setActiveModuleIndex((p) => p - 1);
    console.log(datas[activeModuleIndex]);
        ...
        <div className="watchingCourses">
          <div className="container">
            ...
            <div className="rowGrid">
              <div className="col-16 col-lg-14 p-0 col-sm-24">
                <div className="video">
                  <div className="img">
                    {videoUrl ? (
                      <ReactHlsPlayer
                ...
                <div className="main">
                  <div className="video_title">
                    <TabsUnstyled defaultValue={0}>
                      ...
                      >
                        <CourseRating resData={resData} />
                      </TabPanelUnstyled>
                    </TabsUnstyled>
                  </div>
                </div>
              </div>
              <div className="col-8 col-lg-10 p-0 col-sm-24 d-sm-none">
                <section className="StructureMain">
                  <div className="watch__title">
                    <h1>
                      <svg
