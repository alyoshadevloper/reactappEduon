      ...
      <div className="Courserow rowGrid">
        {myCourses.length > 0 ? (
          myCourses.map((item, index) => (
            <div key={index} className="second_card col-6 col-lg-8 col-sm-24">
              <div className="smImgMedia">
                <img className="imgs" src={courseReact} alt="..." />
                <div className="smCard">
                  <h4>
                    {item.course.name.slice(0, 20) +
                      (item.course.name.length > 20 ? "..." : "")}
                  </h4>
                  <p>
